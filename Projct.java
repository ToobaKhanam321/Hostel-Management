...
class Management extends Hostels implements ActionListener{    //it is our base class 
...
JTextField t01,t02,t03,t04,t09,t009,t010,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12;
...
Management(){        //constructor
   ...
   box05.setBounds(120, 100, 140, 20);
    ...
    jf.add(label118);    
    t09 = new JTextField();
    t09.setBounds(410, 320, 140, 20);
    t09.addActionListener(this);
    jf.add(t09);
...
public void actionPerformed(ActionEvent e){     //override method of ActionListener interface
    ...
    if (str == "Confirm Room"){    //checking either confirm order or calculate total button is pressed
        ...
        t11.setText(s);                       //write value in text field
...
void display(){                                           //override method of abstract class "Write"
    try{                                                //try to run the following code
        File file = new File("Room Details.txt");      //create object of file
        ...
        PrintWriter writer = new PrintWriter(br);           //create object of PrintWriter
        ...
        writer.println(str1);     //write data in file
        writer.println(str2);
        writer.println(str3);
        writer.println(str4);
        writer.println(str5);
        ...
        writer.println(str8);
        writer.println(str9);
        writer.println(str10);
        writer.println(str11);
        writer.println(str12);
        writer.println(str25);
        writer.println(str13);
        writer.println(str14);
        writer.println(str15);
        writer.println(str16);
        writer.println(str28);
        writer.println(str29);
        writer.println(str30);
        writer.println(str31);
        writer.println(str32);
        writer.println(str17);
        writer.println();
        writer.flush();     //enforce all data to write in file
